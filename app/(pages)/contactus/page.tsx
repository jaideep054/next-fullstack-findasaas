  ...
  return (
    <div className="px-6 py-12 bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 relative overflow-hidden">
      {/* <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with us! Whether you have questions, feedback, or partnership inquiries, we're here to help. Contact us today and let's connect."
        />
        <link rel="canonical" href="https://findyoursaas.com/contactus" />
      </Helmet> */}
