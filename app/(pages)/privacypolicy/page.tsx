  ...
  return (
    <div className="px-6 py-12 bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 relative overflow-hidden">
      {/* <Helmet>
        ...
        <meta name="description" content="Privacy policy for FindYourSaaS. Learn how we collect, use, and protect your information." />
        <link rel="canonical" href="https://findyoursaas.com/privacy" />
      </Helmet> */}
