...
const page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-indigo-100 py-16 overflow-hidden relative">
      {/* <Helmet>
        <title>Pricing & FAQ - Find Your SaaS</title>
        <meta name="description" content="Explore our pricing plans! Get a lifetime free listing or choose our featured plan for premium visibility. Check our FAQ for details." />
        <link rel="canonical" href={`https://findyoursaas.com/pricing`} />
      </Helmet> */}
