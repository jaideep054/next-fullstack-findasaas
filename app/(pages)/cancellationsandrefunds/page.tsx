  ...
  return (
    <div className="px-6 py-12 bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 relative overflow-hidden">
      {/* <Helmet>
        ...
        <meta name="description" content="Cancellations and refunds policy for FindYourSaaS. Learn about our process for cancellations and non-refundable purchases." />
        <link rel="canonical" href="https://findyoursaas.com/cancellations-refunds" />
      </Helmet> */}
