  ...
  return (
    <div className="px-6 py-12 bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 relative overflow-hidden">
      {/* <Helmet>
        ...
        <meta name="description" content="Terms and conditions for using FindYourSaaS. Please read these terms carefully before using our platform." />
        <link rel="canonical" href="https://findyoursaas.com/terms" />
      </Helmet> */}
